...
const Modal = ({ toggleModal, toggleDetection, setShowModal }) => {
  ...
  const handleCopyToClipboard = () => {
    const textToCopy = "🖕 at Captcha to show you're not a 🤖";
  ...
  const handleFacebookShare = () => {
    const url = "https://rudecaptcha.xyz";
  ...
  const handleTwitterShare = () => {
    const url = "https://rudecaptcha.xyz";
    const text = encodeURIComponent("🖕 at Captcha to show you're not a 🤖");
      ...
      >
        ...
        {showVidText ? (
          ...
          <div className="flex flex-col items-center justify-center space-y-2 mt-4 w-full px-4">
            <button
              className="w-full py-2 bg-blue-500 text-white rounded hover:bg-blue-700 transition duration-300 ease-in-out shadow-lg"
              onClick={handleFacebookShare}
            >
              Facebook
            </button>
            <button
              className="w-full py-2 bg-black text-white rounded hover:bg-gray-700 transition duration-300 ease-in-out shadow-lg"
              onClick={handleTwitterShare}
            >
              Share on X
            </button>
            <button
              className="w-full py-2 bg-black text-white rounded hover:bg-gray-700 transition duration-300 ease-in-out flex items-center justify-center shadow-lg"
              onClick={() => setShowVidText(true)}
            >
              Share to TikTok
            </button>
            <button
              className="w-full py-2 bg-red-500 text-white rounded hover:bg-pink-700 transition duration-300 ease-in-out flex items-center justify-center shadow-lg"
